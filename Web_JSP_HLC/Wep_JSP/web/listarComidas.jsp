...
<html>
    ...
    <body>
        ...
        <%
            ...
            Comida c1 = new Comida("Tortilla de patatas", "España", new Date(1910, 01, 01), 300, "./imagenes/tortilla.jpg");
            Comida c2 = new Comida("Paella", "España", new Date(1950, 01, 01), 500, "./imagenes/paella.jpg");
            Comida c3 = new Comida("Cocido", "España", new Date(1950, 01, 01), 600, "./imagenes/cocido.jpg");
            Comida c4 = new Comida("Salmorejo", "España", new Date(1950, 01, 01), 200, "./imagenes/salmorejo.jpg");
            Comida c5 = new Comida("Tacos", "México", new Date(1950, 01, 01), 200, "./imagenes/tacos.jpg");
            Comida c6 = new Comida("Enchilada", "México", new Date(1950, 01, 01), 400, "./imagenes/enchiladas.jpg");
            Comida c7 = new Comida("Burrito", "México", new Date(1950, 01, 01), 600, "./imagenes/burritos.jpg");
            Comida c8 = new Comida("Pollo Tandoori", "India", new Date(1950, 01, 01), 300, "./imagenes/pollotandoori.jpg");
            Comida c9 = new Comida("Curries", "India", new Date(1950, 01, 01), 500, "./imagenes/curries.jpg");
            Comida c10 = new Comida("Lassi", "India", new Date(1950, 01, 01), 200, "./imagenes/lassi.jpg");
        ...
        <div class="contenedor">
            <div class="imagenes">
                <img id="espania" width="250" height="160" src="./imagenes/españa.png" alt="Bandera España">
                <img id="mexico" width="250" height="160" src="./imagenes/mexico.png" alt="Bandera México">
                <img id="india" width="250" height="160" src="./imagenes/india.png" alt="Bandera India">
            </div>

            <p id="texto-personalizado"></p>  
            <button id="botonVolver">Atrás</button>>
